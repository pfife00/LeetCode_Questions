...
-- LOGIC:
-- 1) First find login date for each user:
-- SELECT user_id, MIN(activity_date) first_login
-- FROM Traffic
-- WHERE activity = 'login'
-- GROUP BY user_id
--
-- 2) Count number of users in date and filter out ones not between 90 days from
-- today and today (2019-06-30)


SELECT first_login AS login_date, COUNT(*) user_count
FROM
(
    SELECT user_id, MIN(activity_date) first_login
    FROM Traffic
